...
dat.utils.common = (function() {
  ...
  return {
    ...
    compose: function() {
      ...
      return function() {
        for (var g = c.call(arguments), a = e.length - 1; 0 <= a; a--)
          g = [e[a].apply(this, g)];
        return g[0];
      };
    },
    each: function(c, g, a) {
      if (m && c.forEach === m) c.forEach(g, a);
        ...
        for (
          var d = 0, b = c.length;
          d < b && !(d in c && g.call(a, c[d], d) === this.BREAK);
          d++
        );
      ...
      if (a.litmus(d))
        return (
          c.each(a.conversions, function(a, b) {
            ...
            if (!1 === g && !1 !== e)
              return (
                (g = e), (e.conversionName = b), (e.conversion = a), c.BREAK
              );
          }),
          c.BREAK
        );
...
dat.GUI = dat.gui.GUI = (function(m, c, e, g, a, d, b, l, k, h, f, q, n, p, u) {
  function r(b, c, d, e) {
    if (void 0 === c[d])
      throw Error("Object " + c + ' has no property "' + d + '"');
    e.color
      ? (c = new f(c, d))
      : ((c = [c, d].concat(e.factoryArgs)), (c = g.apply(b, c)));
      ...
      Object.defineProperties(this, {
        ...
        closed: {
          ...
          set: function(b) {
            a.closed = b;
            a.closed
              ? p.addClass(d.__ul, F.CLASS_CLOSED)
              : p.removeClass(d.__ul, F.CLASS_CLOSED);
            this.onResize();
            d.__closeButton &&
              (d.__closeButton.innerHTML = b ? F.TEXT_OPEN : F.TEXT_CLOSED);
          }
        },
        load: {
          get: function() {
        ...
        useLocalStorage: {
          ...
          set: function(a) {
            J &&
              ((e = a)
                ? p.bind(window, "unload", b)
                : p.unbind(window, "unload", b),
  ...
  u.extend(F.prototype, {
    ...
    onResize: function() {
      ...
      if (a.scrollable) {
        ...
        window.innerHeight - b - 20 < c
          ...
          : (p.removeClass(a.domElement, F.CLASS_TOO_TALL),
    ...
    saveAs: function(a) {
      this.load.remembered ||
        ((this.load.remembered = {}),
        (this.load.remembered.Default = A(this, !0)));
  ...
  (dat.controllers.factory = (function(m, c, e, g, a, d, b) {
    return function(l, k, h, f) {
      ...
      if (b.isNumber(q))
        return b.isNumber(h) && b.isNumber(f)
          ? new e(l, k, h, f)
          : new c(l, k, { min: h, max: f });
    ...
    (dat.color.Color = (function(m, c, e, g) {
        ...
        Object.defineProperty(a, c, {
          ...
          set: function(a) {
            "RGB" !== this.__state.space &&
              (b(this, c, d), (this.__state.space = "RGB"));
            this.__state[c] = a;
          }
        });
      }
      ...
      function b(a, b, d) {
        if ("HEX" === a.__state.space)
          a.__state[b] = c.component_from_hex(a.__state.hex, d);
        else if ("HSV" === a.__state.space)
          g.extend(
            a.__state,
            c.hsv_to_rgb(a.__state.h, a.__state.s, a.__state.v)
          );
      ...
      function l(a) {
        ...
        g.isNaN(b.h)
          ? g.isUndefined(a.__state.h) && (a.__state.h = 0)
          : (a.__state.h = b.h);
      }
      var k = function() {
  ...
  (dat.dom.CenteredDiv = (function(m, c) {
    ...
    e.prototype.layout = function() {
      this.domElement.style.left =
        window.innerWidth / 2 - m.getWidth(this.domElement) / 2 + "px";
      this.domElement.style.top =
        window.innerHeight / 2 - m.getHeight(this.domElement) / 2 + "px";
    };
    return e;
      ...
      createjs.Tween.get(f)
        ...
        .call(function() {
          createjs.Tween.get(f)
            .wait(250)
            .to(
              { y: CANVAS_HEIGHT + k.getBounds().height },
              500,
...
function sizeHandler() {
  ...
  if ($("#canvas")) {
    ...
    if (g < m) {
      ...
      e < c &&
        ((a = c - e), (e += a), (g += (CANVAS_HEIGHT / CANVAS_WIDTH) * a));
    a = m / 2 - g / 2;
    var d = c / 2 - e / 2,
      b = CANVAS_WIDTH / e;
...
function getParamValue(m) {
  for (
    var c = window.location.search.substring(1).split("&"), e = 0;
    e < c.length;
    e++
  ) {
    var g = c[e].split("=");
...
!(function(m) {
  ...
  return (function a(c, e, g) {
    ...
    for (
      var b = "function" == typeof require && require, l = 0;
      l < g.length;
      l++
    )
      d(g[l]);
      ...
      5: [
        function(c, e, g) {
          ...
          a.boundingSphereCheck = function(b, a) {
            ...
            return (
              Math.pow(
                b.shape.boundingSphereRadius + a.shape.boundingSphereRadius,
                2
              ) > n.norm2()
            );
          };
            ...
            for (e = 0; e !== h; e++) {
              ...
              switch (E.type) {
                case F:
                  ...
                  break;
                case y:
                  E.worldNormalNeedsUpdate &&
                    E.computeWorldNormal(f.quaternion);
                  Y = E.worldNormal;
            ...
            for (e = 0; e !== A; e++)
              if (((h = I[e]), 1 < h))
                for (b = N[e], T = 0; T !== h; T++)
                  for (f = b[T], Q = 0; Q !== T; Q++)
                    (C = b[Q]),
                      this.needBroadphaseCollision(f, C) &&
                        this.intersectionTest(f, C, a, d);
          ...
          a.prototype.collisionPairs = function(b, a, d) {
            ...
            for (f = 0; f !== c; f++)
              for (l = 0; l !== f; l++) {
                var e = b[f];
                var k = b[l];
                this.needBroadphaseCollision(e, k) &&
                  this.intersectionTest(e, k, a, d);
              }
          };
          new c();
          a.prototype.aabbQuery = function(b, a, d) {
        ...
        function(c, e, g) {
          ...
          a.prototype.intersectWorld = function(b, d) {
            ...
            this.collisionFilterMask =
              "undefined" !== typeof d.collisionFilterMask
                ? d.collisionFilterMask
                : -1;
            this.collisionFilterGroup =
              "undefined" !== typeof d.collisionFilterGroup
                ? d.collisionFilterGroup
                : -1;
          ...
          a.prototype.intersectPlane = function(a, d, c, h) {
            ...
            if (
              !(
                0 < d * k ||
                f.distanceTo(l) < d ||
                ((k = n.dot(e)), Math.abs(k) < this.precision)
              )
            ) {
              var q = new b();
              l = new b();
          ...
          a.prototype.intersectConvex = function(b, a, c, h, f) {
            ...
            for (
              ...
              E = k.dot(A);
              if (
                !(Math.abs(E) < this.precision || ((E = A.dot(D) / E), 0 > E))
              )
                for (
                  k.mult(E, r),
                    r.vadd(q, r),
          ...
          a.prototype.reportIntersection = function(b, d, c, h, f) {
            ...
            if (!(this.skipBackfaces && 0 < b.dot(this._direction)))
              switch (
                ((k.hitFaceIndex = "undefined" !== typeof f ? f : -1),
                this.mode)
              ) {
                case a.ALL:
                  this.hasHit = !0;
      ...
      11: [
        function(c, e, g) {
          ...
          a.prototype.sortList = function() {
            for (
              var b = this.axisList, d = this.axisIndex, c = b.length, h = 0;
              h !== c;
              h++
            ) {
              var f = b[h];
      ...
      12: [
        function(c, e, g) {
          function a(a, c, e) {
            ...
            this.twistAngle =
              "undefined" !== typeof e.twistAngle ? e.twistAngle : 0;
            f.maxForce = 0;
            f.minForce = -h;
            a.maxForce = 0;
            a.minForce = -h;
      ...
      13: [
        function(c, e, g) {
          ...
          a.prototype.enable = function() {
            for (var b = this.equations, a = 0; a < b.length; a++)
              b[a].enabled = !0;
          };
        ...
        function(c, e, g) {
          ...
          a.prototype.update = function() {
            ...
            this.motorEquation.enabled &&
              (b.quaternion.vmult(this.axisA, c.axisA),
              a.quaternion.vmult(this.axisB, c.axisB));
          };
        },
        {
          "../equations/ContactEquation": 19,
        ...
        function(c, e, g) {
          ...
          a.prototype.computeGq = function() {
            var b = this.jacobianElementB,
              a = this.bj.position;
            return (
              this.jacobianElementA.spatial.dot(this.bi.position) +
              b.spatial.dot(a)
            );
          };
          var b = new c();
          a.prototype.computeGW = function() {
            ...
            return (
              this.jacobianElementA.multiplyVectors(
                c.velocity,
                c.angularVelocity || b
          ...
          a.prototype.computeGiMf = function() {
            var a = this.jacobianElementA,
              ...
              C = c.invMassSolve,
              A = d.invMassSolve;
            c.invInertiaWorldSolve
              ? c.invInertiaWorldSolve.vmult(n, h)
              : h.set(0, 0, 0);
            d.invInertiaWorldSolve
              ? d.invInertiaWorldSolve.vmult(g, f)
              : f.set(0, 0, 0);
            e.mult(C, l);
            q.mult(A, k);
      ...
      25: [
        function(c, e, g) {
          function a(c) {
            ...
            this.restitution =
              "undefined" !== typeof c.restitution ? c.restitution : -1;
          }
          e.exports = a;
          a.idCounter = 0;
        },
      ...
      26: [
        function(c, e, g) {
          ...
          a.prototype.multiplyElement = function(a) {
            return (
              a.spatial.dot(this.spatial) + a.rotational.dot(this.rotational)
            );
          };
      ...
      27: [
        function(c, e, g) {
          ...
          a.prototype.solve = function(a, c) {
            ...
            var f;
            for (e = 0; 3 > e; e++)
              for (f = 0; 3 > f; f++) b[e + 4 * f] = this.elements[e + 3 * f];
            b[3] = a.x;
            b[7] = a.y;
            b[11] = a.z;
            var l = 3,
          ...
          a.prototype.reverse = function(b) {
            ...
            var e;
            for (d = 0; 3 > d; d++)
              for (e = 0; 3 > e; e++) c[d + 6 * e] = this.elements[d + 3 * e];
            c[3] = 1;
            c[9] = 0;
            c[15] = 0;
            c[4] = 0;
        ...
        function(c, e, g) {
          ...
          a.prototype.setFromVectors = function(a, c) {
            if (a.isAntiparallelTo(c))
              a.tangents(b, l), this.setFromAxisAngle(b, Math.PI);
            else {
              var d = a.cross(c);
              this.x = d.x;
              this.y = d.y;
              this.z = d.z;
              this.w =
                Math.sqrt(Math.pow(a.norm(), 2) * Math.pow(c.norm(), 2)) +
                a.dot(c);
              this.normalize();
            }
          };
          ...
          a.prototype.toEuler = function(a, b) {
            ...
            switch (b) {
              case "YZX":
                ...
                -0.499 > h &&
                  ((n = -2 * Math.atan2(c, f)), (g = -Math.PI / 2), (l = 0));
                isNaN(n) &&
                  ((l = e * e),
                  (n = Math.atan2(
                    2 * d * f - 2 * c * e,
      ...
      31: [
        function(c, e, g) {
          function a(c) {
            ...
            this.vlambda = new b();
            this.collisionFilterGroup =
              "number" === typeof c.collisionFilterGroup
            ...
            this.linearDamping =
              "number" === typeof c.linearDamping ? c.linearDamping : 0.01;
            this.type = 0 >= e ? a.STATIC : a.DYNAMIC;
            typeof c.type === typeof a.STATIC && (this.type = c.type);
            this.allowSleep =
              "undefined" !== typeof c.allowSleep ? c.allowSleep : !0;
            this.sleepState = 0;
            this.sleepSpeedLimit =
              "undefined" !== typeof c.sleepSpeedLimit
                ? c.sleepSpeedLimit
                : 0.1;
            this.sleepTimeLimit =
              "undefined" !== typeof c.sleepTimeLimit ? c.sleepTimeLimit : 1;
            ...
            this.fixedRotation =
              "undefined" !== typeof c.fixedRotation ? c.fixedRotation : !1;
            this.angularDamping =
              "undefined" !== typeof c.angularDamping ? c.angularDamping : 0.01;
            this.userData =
              "undefined" !== typeof c.userData ? c.userData : null;
            this.aabb = new h();
          ...
          a.prototype.applyLocalForce = function(b, c) {
            this.type === a.DYNAMIC &&
              (this.vectorToWorldFrame(b, v),
              this.pointToWorldFrame(c, x),
              this.applyForce(v, x));
          };
          var z = new b(),
            C = new b(),
          ...
          a.prototype.applyLocalImpulse = function(b, c) {
            this.type === a.DYNAMIC &&
              (this.vectorToWorldFrame(b, D),
              this.pointToWorldFrame(c, G),
              this.applyImpulse(D, G));
          };
          var B = new b();
      ...
      32: [
        function(c, e, g) {
          function a(a) {
            ...
            this.world = null;
            this.indexRightAxis =
              "undefined" !== typeof a.indexRightAxis ? a.indexRightAxis : 1;
            this.indexForwardAxis =
              "undefined" !== typeof a.indexForwardAxis
                ? a.indexForwardAxis
                : 0;
            this.indexUpAxis =
              "undefined" !== typeof a.indexUpAxis ? a.indexUpAxis : 2;
          }
          function d(a, b, c) {
            var d = C,
              e = A,
          ...
          a.prototype.updateVehicle = function(a) {
            ...
            for (f = 0; f < d; f++) {
              ...
              (!n.sliding && n.isInContact) ||
                ...
                (n.deltaRotation =
                  (0 < n.engineForce ? 1 : -1) *
                  n.customSlidingRotationalSpeed *
                  a);
              Math.abs(n.brake) > Math.abs(n.engineForce) &&
                (n.deltaRotation = 0);
          ...
          a.prototype.castRay = function(a) {
            ...
            e
              ? ((d = f.distance),
                ...
                a.suspensionLength > e &&
                  ((a.suspensionLength = e), a.raycastResult.reset()),
                ...
                -0.1 <= f
                  ? ((a.suspensionRelativeVelocity = 0),
                    (a.clippedInvContactDotSuspension = 10))
                  : ((f = -1 / f),
                    (a.suspensionRelativeVelocity = c * f),
                    (a.clippedInvContactDotSuspension = f)))
              : ((a.suspensionLength =
                  a.suspensionRestLength + 0 * a.maxSuspensionTravel),
                (a.suspensionRelativeVelocity = 0),
          ...
          a.prototype.updateWheelTransformWorld = function(a) {
            ...
            b.pointToWorldFrame(
              a.chassisConnectionPointLocal,
              a.chassisConnectionPointWorld
            );
          ...
          a.prototype.updateFriction = function(a) {
            ...
            for (h = 0; h < e; h++)
              if (((g = c[h]), (l = g.raycastResult.body))) {
                var k = w[h];
                this.getWheelTransformWorld(h).vectorToWorldFrame(
                  u[this.indexRightAxis],
                  k
                );
      ...
      33: [
        function(c, e, g) {
          function a(a) {
            ...
            this.chassisBody = a.chassisBody;
            this.chassisBody ||
              ((a = new l(new k(5, 2, 0.5))), (this.chassisBody = new d(1, a)));
            this.constraints = [];
            this.wheelAxes = [];
            this.wheelForces = [];
          }
          ...
          a.prototype.addToWorld = function(a) {
            for (
              var b = this.constraints,
                c = this.wheelBodies.concat([this.chassisBody]),
                d = 0;
              d < c.length;
              d++
            )
              ...
              for (z = 0; z !== v; z++)
                (x = t[z]),
                  ...
                  (g =
                    -x.mass *
                    (this.pressures[e] /
                      (this.densities[e] * this.densities[e] + d) +
                      this.pressures[z] /
                        (this.densities[z] * this.densities[z] + d))),
                  this.gradw(f, h),
                  h.mult(g, h),
                  l.vadd(h, l),
                  x.velocity.vsub(c.velocity, q),
                  q.mult(
                    (1 / (1e-4 + this.densities[e] * this.densities[z])) *
                      this.viscosity *
                      x.mass,
                    q
                  ),
      ...
      35: [
        function(c, e, g) {
          function a(a, b, c) {
            c = c || {};
            this.restLength =
              "number" === typeof c.restLength ? c.restLength : 1;
        ...
        function(c, e, g) {
          function a(a) {
            ...
            this.useCustomSlidingRotationalSpeed =
              a.useCustomSlidingRotationalSpeed;
            this.sliding = !1;
      ...
      37: [
        function(c, e, g) {
          ...
          a.prototype.getSideNormals = function(a, b) {
            ...
            a[5].set(0, 0, -c.z);
            if (void 0 !== b)
              for (c = 0; c !== a.length; c++) b.vmult(a[c], a[c]);
            return a;
          };
      ...
      38: [
        function(c, e, g) {
          ...
          a.prototype.clipAgainstHull = function(a, c, d, e, f, g, h, l, n) {
            for (
              var k = -1, p = -Number.MAX_VALUE, r = 0;
              r < d.faces.length;
              r++
            ) {
          ...
          a.prototype.findSeparatingAxis = function(a, b, c, d, e, f, g, h) {
            ...
            if (this.uniqueAxes)
              ...
              for (
                var q = g ? g.length : this.faces.length, y = 0;
                y < q;
                y++
              ) {
                B = g ? g[y] : y;
            ...
            for (h = 0; h !== this.uniqueEdges.length; h++)
              for (
                c.vmult(this.uniqueEdges[h], r), k = 0;
                k !== a.uniqueEdges.length;
                k++
              )
                if (
                  (e.vmult(a.uniqueEdges[k], w), r.cross(w, t), !t.almostZero())
                ) {
                  t.normalize();
          ...
          a.prototype.clipFaceAgainstHull = function(a, b, c, d, e, f, g) {
            for (
              var h = [], l = -1, k = Number.MAX_VALUE, n = 0;
              n < this.faces.length;
              n++
            ) {
            ...
            if (!(0 > l)) {
              ...
              for (n = 0; n < k; n++) {
                ...
                c.vmult(K, K);
                p -= K.dot(b);
                for (this.clipFaceAgainstPlane(d, h, K, p); d.length; )
                  d.shift();
          ...
          a.prototype.computeWorldVertices = function(a, c) {
            ...
            for (
              var e = this.vertices, f = this.worldVertices, g = 0;
              g !== d;
              g++
            )
          ...
          a.prototype.computeWorldFaceNormals = function(a) {
            for (
              var c = this.faceNormals.length;
              this.worldFaceNormals.length < c;

            )
              this.worldFaceNormals.push(new b());
            for (
              var d = this.faceNormals, e = this.worldFaceNormals, f = 0;
              f !== c;
              f++
            )
              a.vmult(d[f], e[f]);
          ...
          a.prototype.getAveragePointLocal = function(a) {
            a = a || new b();
            for (
              var c = this.vertices.length, d = this.vertices, e = 0;
              e < c;
              e++
            )
              a.vadd(d[e], a);
          ...
          a.prototype.transformAllPoints = function(a, b) {
            ...
            if (b) {
              ...
              for (e = 0; e < this.faceNormals.length; e++)
                (f = this.faceNormals[e]), b.vmult(f, f);
            }
      ...
      40: [
        function(c, e, g) {
          ...
          a.prototype.setHeightValueAtIndex = function(a, b, c) {
            ...
            0 < b &&
              0 < a &&
              this.clearCachedConvexTrianglePillar(a - 1, b - 1, !0);
          };
          ...
          a.prototype.getIndexOfPosition = function(a, b, c, d) {
            ...
            return 0 > a || 0 > b || a >= f.length - 1 || b >= f[0].length - 1
              ? !1
              : !0;
          };
          ...
          a.prototype.getCachedConvexTrianglePillar = function(a, b, c) {
            return this._cachedPillars[
              this.getCacheConvexTrianglePillarKey(a, b, c)
            ];
          };
          ...
          a.prototype.getConvexTrianglePillar = function(a, c, d) {
            ...
            e.vertices.length = 6;
            for (var q = 0; 6 > q; q++)
              e.vertices[q] || (e.vertices[q] = new l());
            k.length = 5;
            for (q = 0; 5 > q; q++) k[q] || (k[q] = []);
            q = e.vertices;
            var v =
              (Math.min(g[a][c], g[a + 1][c], g[a][c + 1], g[a + 1][c + 1]) -
                this.minValue) /
                2 +
              this.minValue;
            d
      ...
      45: [
        function(c, e, g) {
          ...
          a.prototype.setScale = function(a) {
            var b = (a.x === a.y) === a.z;
            ((this.scale.x === this.scale.y) === this.scale.z && b) ||
              this.updateNormals();
            this.scale.copy(a);
            this.updateAABB();
            this.updateBoundingSphereRadius();
        ...
        function(c, e, g) {
          ...
          a.prototype.solve = function(a, c) {
            var d = 0,
              ...
              v;
            if (0 !== h)
              for (v = 0; v !== t; v++) w[v].updateSolveMassProperties();
            l.length = h;
            k.length = h;
            b.length = h;
            for (v = 0; v !== h; v++) {
          ...
          a.prototype.solve = function(a, c) {
            ...
            for (u.iterations = this.iterations; (A = d(h)); ) {
              ...
              for (A(e, n, r); p.length; )
                for (e = p.pop(); (D = d(e.children)); )
                  (D.visited = !0), A(D, n, r), p.push(D);
              n = k.length;
              k = k.sort(l);
        ...
        function(c, e, g) {
          ...
          a.prototype.insert = function(a, b, c) {
            ...
            if (c < (this.maxDepth || this.root.maxDepth)) {
              ...
              for (var g = 0; 8 !== g; g++)
                if (e[g].insert(a, b, c + 1)) return !0;
              f && (e.length = 0);
            }
            d.push(b);
            return !0;
        ...
        function(c, e, g) {
          ...
          a.prototype.getContacts = function(a, b, c, d, e, f, g) {
            ...
            for (e = a.length; d !== e; d++) {
              ...
              f.material &&
                g.material &&
                (h = c.getContactMaterial(f.material, g.material) || null);
              for (var l = 0; l < f.shapes.length; l++) {
                ...
                for (var k = f.shapes[l], n = 0; n < g.shapes.length; n++) {
                  ...
                  if (
                    !(
                      r.distanceTo(w) >
                      k.boundingSphereRadius + p.boundingSphereRadius
                    )
                  ) {
                    var y = null;
                    k.material &&
                      p.material &&
                      (y =
                        c.getContactMaterial(k.material, p.material) || null);
                    this.currentContactMaterial =
                      y || h || c.defaultContactMaterial;
          ...
          a.prototype[
            g.types.BOX | g.types.BOX
          ] = a.prototype.boxBox = function(a, b, c, d, e, f, g, h) {
            a.convexPolyhedronRepresentation.material = a.material;
            b.convexPolyhedronRepresentation.material = b.material;
            a.convexPolyhedronRepresentation.collisionResponse =
              a.collisionResponse;
            b.convexPolyhedronRepresentation.collisionResponse =
              b.collisionResponse;
            this.convexConvex(
          ...
          a.prototype[
            g.types.BOX | g.types.CONVEXPOLYHEDRON
          ] = a.prototype.boxConvex = function(a, b, c, d, e, f, g, h) {
            a.convexPolyhedronRepresentation.material = a.material;
            a.convexPolyhedronRepresentation.collisionResponse =
              a.collisionResponse;
            this.convexConvex(
          ...
          a.prototype[
            g.types.BOX | g.types.PARTICLE
          ] = a.prototype.boxParticle = function(a, b, c, d, e, f, g, h) {
            a.convexPolyhedronRepresentation.material = a.material;
            a.convexPolyhedronRepresentation.collisionResponse =
              a.collisionResponse;
            this.convexParticle(
          ...
          var x = new b(),
            ...
            C = new b();
          a.prototype[
            g.types.PLANE | g.types.TRIMESH
          ] = a.prototype.planeTrimesh = function(a, c, d, e, f, g, h, k) {
            var n = new b();
            x.set(0, 0, 1);
            f.vmult(x, x);
          ...
          var G = new b(),
            ...
            P = [];
          a.prototype[
            g.types.SPHERE | g.types.TRIMESH
          ] = a.prototype.sphereTrimesh = function(a, b, c, e, f, g, h, k) {
            ...
            for (f = 0; f < P.length; f++)
              for (var p = 0; 3 > p; p++)
                if (
                  (b.getVertex(b.indices[3 * P[f] + p], G),
                  G.vsub(H, D),
                  D.norm2() <= n)
                ) {
                  B.copy(G);
          ...
          var E = new b(),
            T = new b();
          a.prototype[
            g.types.SPHERE | g.types.PLANE
          ] = a.prototype.spherePlane = function(a, b, c, d, e, f, g, h) {
          ...
          var Q = new b(),
            ...
            na = new b();
          a.prototype[
            g.types.SPHERE | g.types.BOX
          ] = a.prototype.sphereBox = function(a, b, c, d, e, f, g, h) {
            e = this.v3pool;
            c.vsub(d, R);
          ...
          new b();
          a.prototype[
            g.types.PLANE | g.types.BOX
          ] = a.prototype.planeBox = function(a, b, c, d, e, f, g, h) {
            b.convexPolyhedronRepresentation.material = b.material;
            b.convexPolyhedronRepresentation.collisionResponse =
              b.collisionResponse;
            this.planeConvex(
          ...
          a.prototype[
            ...
            this.enableFrictionReduction &&
              e &&
              this.createFrictionFromAverage(e);
          };
          var ra = new b(),
            oa = new b();
          a.prototype[
            g.types.CONVEXPOLYHEDRON
          ] = a.prototype.convexConvex = function(
            a,
            b,
            c,
            d,
            ...
            if (
              !(
                c.distanceTo(d) >
                a.boundingSphereRadius + b.boundingSphereRadius
              ) &&
          ...
          var da = new b(),
            ...
            pa = new b();
          a.prototype[
            g.types.PLANE | g.types.PARTICLE
          ] = a.prototype.planeParticle = function(a, b, c, d, e, f, g, h) {
            da.set(0, 0, 1);
          ...
          var ia = new b();
          a.prototype[
            g.types.PARTICLE | g.types.SPHERE
          ] = a.prototype.sphereParticle = function(a, b, c, d, e, f, g, h) {
            ia.set(0, 0, 1);
            d.vsub(c, ia);
          ...
          a.prototype[
            g.types.BOX | g.types.HEIGHTFIELD
          ] = a.prototype.boxHeightfield = function(a, b, c, d, e, f, g, h) {
            a.convexPolyhedronRepresentation.material = a.material;
            a.convexPolyhedronRepresentation.collisionResponse =
              a.collisionResponse;
                ...
                for (p = q; p < y; p++)
                  for (q = r; q < n; q++)
                    b.getConvexTrianglePillar(p, q, !1),
                      ...
                      c.distanceTo(la) <
                        b.pillarConvex.boundingSphereRadius +
                          a.boundingSphereRadius &&
                        this.convexConvex(
                          a,
                          b.pillarConvex,
                          c,
      ...
      56: [
        function(c, e, g) {
          function a() {
            ...
            this.defaultContactMaterial = new q(
          ...
          a.prototype.step = function(a, b, c) {
            ...
            if (0 === b) this.internalStep(a), (this.time += a);
              ...
              var d =
                Math.floor((this.time + b) / a) - Math.floor(this.time / a);
              d = Math.min(d, c);
              c = performance.now();
              for (
                var e = 0;
                e !== d &&
                !(this.internalStep(a), performance.now() - c > 1e3 * a);
                e++
              );
              this.time += b;
              a = (this.time % a) / a;
          ...
          a.prototype.internalStep = function(a) {
            ...
            for (r = 0; r !== f; r++)
              (q = b[r]),
                ...
                t.material &&
                  u.material &&
                  this.getContactMaterial(t.material, u.material),
                t.material &&
                  u.material &&
                  0 <= t.material.restitution &&
                  0 <= u.material.restitution &&
                  (q.restitution =
                    t.material.restitution * u.material.restitution),
                e.addEquation(q),
                t.allowSleep &&
                  t.type === n.DYNAMIC &&
                ...
                this.collisionMatrixPrevious.get(t, u) ||
                  ...
                  u.dispatchEvent(A));
            g &&
              ((h.makeContactConstraints = performance.now() - l),
              (l = performance.now()));
            for (f = 0; f !== c; f++)
              (t = d[f]),
                t._wakeUpAfterNarrowphase &&
                  (t.wakeUp(), (t._wakeUpAfterNarrowphase = !1));
            t = p.length;
            for (f = 0; f !== t; f++)
              for (
                q = p[f], q.update(), r = 0, b = q.equations.length;
                r !== b;
                r++
              )
            ...
            for (f = 0; f !== c; f++)
              (t = d[f]), t.preStep && t.preStep.call(t);
            g && (l = performance.now());
            ...
            for (f = 0; f !== c; f++)
              if (
                ...
                u.z += q.z * X * a;
                t.angularVelocity &&
                  (ha.vmult(r, K), K.mult(a, K), K.vadd(v, v));
                w.x += u.x * a;
                w.y += u.y * a;
                w.z += u.z * a;
                t.angularVelocity &&
            ...
            if (this.allowSleep)
              for (f = 0; f !== c; f++) d[f].sleepTick(this.time);
          };
...
THREE.TrackballControls = function(m, c) {
  ...
  var D = (function() {
      ...
      return function(c, d) {
        a.set(
          (c - b.screen.left) / b.screen.width,
          (d - b.screen.top) / b.screen.height
        );
        return a;
      };
    })(),
  ...
  this.rotateCamera = (function() {
    ...
    return function() {
      ...
      d &&
        ...
        b.staticMoving
          ? n.copy(p)
          : (c.setFromAxisAngle(a, d * (b.dynamicDampingFactor - 1)),
            n.applyQuaternion(c)));
    };
  })();
    ...
    if (h === l.TOUCH_ZOOM_PAN) {
      ...
      (a = 1 + (r.y - u.y) * b.zoomSpeed),
        1 !== a &&
          ...
          b.staticMoving
            ? u.copy(r)
            : (u.y += (r.y - u.y) * this.dynamicDampingFactor));
  };
  ...
  this.update = function() {
    ...
    1e-6 < k.distanceToSquared(b.object.position) &&
      (b.dispatchEvent(z), k.copy(b.object.position));
  };
  this.reset = function() {
    f = h = l.NONE;
...
TEXT_SHARE_SHARE2 = " points! Can you do better?";function CGoalKeeper(m, c, e) {
    var g,
      a,
      d,
      b,
  ...
  CANNON.Demo.prototype.shape2mesh = function(m, c) {
    ...
    this.buttonDown = function() {
      f ||
        ...
        (b.scaleY = 0.9),
        a[ON_MOUSE_DOWN] &&
          a[ON_MOUSE_DOWN].call(d[ON_MOUSE_DOWN], l[ON_MOUSE_DOWN]));
    };
      ...
      if (!(w || k.y < h.y || (0 === h.x && 0 === h.y))) {
        ...
        if (M > TIME_SWIPE) M = 0;
          ...
          b > HIT_BALL_MIN_FORCE &&
            (b > HIT_BALL_MAX_FORCE &&
              (a.normalize(), a.scalarProduct(HIT_BALL_MAX_FORCE)),
            (x = !0),
            q.setVisible(!0),
            (b = M / 10),
            b > MAX_FORCE_Y
              ? (b = MAX_FORCE_Y)
              : b < MIN_FORCE_Y && (b = MIN_FORCE_Y),
            N.set(
              -a.getX() * FORCE_MULTIPLIER_AXIS.x,
              b,
              a.getY() * FORCE_MULTIPLIER_AXIS.z
            ),
    ...
    this.refreshShadowCast = function(b, a, d) {
      ...
      if (a.position.z < c.position.z) b.scaleShadow(0);
        ...
        var h = this.convert3dPosTo2dScreen(
          { x: a.position.x, y: a.position.y, z: c.position.z },
          P
        );
        a =
          (a.position.z - BALL_RADIUS) *
            (c.position.z - SHADOWN_FACTOR - c.position.z) +
          c.position.z;
        d *= a;
        b.scaleShadow(d);
    ...
    this.calculateScore = function() {
      var b =
        MAX_PERCENT_PROBABILITY -
        (MAX_PERCENT_PROBABILITY - AREAS_INFO[B].probability);
      this.addScore(b * F, b);
      F += MULTIPLIER_STEP;
    };
    ...
    this.goalAnimation = function(b) {
      b > FORCE_BALL_DISPLAY_SHOCK[0].min && b < FORCE_BALL_DISPLAY_SHOCK[0].max
        ...
        : b > FORCE_BALL_DISPLAY_SHOCK[1].min &&
          b < FORCE_BALL_DISPLAY_SHOCK[1].max
          ? this.displayShock(
              INTENSITY_DISPLAY_SHOCK[1].time,
              INTENSITY_DISPLAY_SHOCK[1].x,
              INTENSITY_DISPLAY_SHOCK[1].y
            )
          : b > FORCE_BALL_DISPLAY_SHOCK[2].min &&
            b < FORCE_BALL_DISPLAY_SHOCK[2].max
            ? this.displayShock(
    ...
    this.displayShock = function(b, a, d) {
      createjs.Tween.get(l)
        .to(
          { x: Math.round(Math.random() * a), y: Math.round(Math.random() * d) },
          b
        )
        .call(function() {
          createjs.Tween.get(l)
    ...
    this.swapChildrenIndex = function() {
      for (var b = 0; b < y.length - 1; b++)
        for (var a = b + 1; a < y.length; a++)
          y[b].getObject().visible &&
            y[a].getObject().visible &&
            this.sortDepth(y[b], y[a]);
    };
  ...
  ENABLE_FULLSCREEN,
  ENABLE_CHECK_ORIENTATION,
  TIME_SWIPE;function CRollingScore() {
    var m = null,
      c = null;
    ...
    this.animFade = function(a) {
      ...
      createjs.Tween.get(d)
        ...
        .call(function() {
          0 === a &&
            ((d.visible = !1),
            c.hideCharacter(NUM_SPRITE_PLAYER - 1),
            c.viewCharacter(b));
        });
    };
